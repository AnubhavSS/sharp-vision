...
/**
 * Collections component that displays featured eyewear collections in a grid layout.
 * Each collection card has hover effects with image zoom and animated text reveal.
 */
