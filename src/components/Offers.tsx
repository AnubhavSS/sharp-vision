...
/**
 * Offers component that displays current promotions and special deals.
 * Features animated cards with hover effects and gradient colors.
 */
export default function Offers() {
  ...
  /**
   * Custom Tag component that renders a Zap icon
          ...
          {offers.map((offer, index) => {
            ...
            return (
              ...
              >
                {/* Gradient background */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${offer.color} opacity-10 group-hover:opacity-100 transition-opacity duration-500`}
                ></div>
                ...
                <div className="relative z-20 p-8 flex flex-col items-center text-center h-full">
                  <div
                    className={`w-16 h-16 rounded-full bg-gradient-to-br ${offer.color} flex items-center justify-center text-white mb-6 shadow-lg shadow-black/10 group-hover:scale-110 transition-transform duration-500`}
                  >
